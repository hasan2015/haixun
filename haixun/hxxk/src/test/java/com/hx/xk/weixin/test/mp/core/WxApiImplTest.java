package com.hx.xk.weixin.test.mp.core;
...
import com.hx.xk.weixin.test.testunit.TestSupport;
...
public class WxApiImplTest extends TestSupport {
	...
	public void testCreateMenu() throws Exception {
		...
		// 1
		Menu m1 = new Menu(new String("血压管理".getBytes("UTF-8"), "UTF-8"), Menu.VIEW,
				"http://121.43.168.2/hbweixin/page/bloodpre.jsp");
		// 2
		Menu m2 = new Menu("血糖管理", Menu.VIEW, "http://121.43.168.2/hbweixin/page/bloodsugar.jsp");
		// 2
		Menu m3 = new Menu("我");
		Menu family = new Menu("家人", Menu.VIEW, "http://121.43.168.2/hbweixin/page/family.jsp");
		Menu product = new Menu("服务", Menu.VIEW, "http://121.43.168.2/hbweixin/page/service.jsp");
		Menu doctor = new Menu("医生", Menu.VIEW, "http://121.43.168.2/hbweixin/page/fdoctor.jsp");
		m3.setSubButtons(Arrays.asList(family, product, doctor));
	...
	public void testSendCustomerMsg() throws Exception {
		...
		// 图像客服消息
		/*
		 * msg.setMsgType(WxApi.IMAGE); msg.setMediaId(mediaId); flag =
		 * wxApi.sendCustomerMsg(msg); System.out.println("发送图像客服消息: " + flag);
		 */
	}

	@Test
	public void testSendTemplateMsg() throws Exception {
		Template first = new Template("first", "#fffff", "您好，张三刚刚测量了糖，结果如下：");
		Template keyword1 = new Template("keyword1", "#cccccc", "4.9mmol/L");
		Template keyword2 = new Template("keyword2", "#000000", "正常");
		Template remark = new Template("remark", "#000000", "今天正常,继续保持哦");
		boolean flag = wxApi.sendTemplateMsg(openId, templateId, "#FF0000", "", first, keyword1, keyword2, remark);
	...
	public void testUpNews() throws Exception {
		...
		art2.setShowCover(1);
		art2.setSourceUrl(
				"http://mp.weixin.qq.com/s?__biz=MzA4OTEwNDkyMw==&mid=201489837&idx=2&sn=a86b67dd34894ee1f124b2ddcd02c35b#rd");
	...
	public void testUpVideo() throws Exception {
		...
		String mediaId = "KIV7QppP1LEwsXcUiSHx5BZEV4sIW53a_iX7uHWtU8QyG4maRvPiodiR_6t4JkX3"; // wxApi.upMedia(WxApi.VIDEO,
																								// mp4);
	...
	public void testSendAll() throws Exception {
		 ...
		 * outmsg.setMsgType(WxApi.MPVIDEO); outmsg.setGroupId("104"); String
		 * msgid = wxApi.sendAll(outmsg); System.out.println("video msgid:"
		 * +msgid);
		 */// 2348282861
	}
	...
	@Test
	public void getJsAPISign() throws Exception {
		Map<String, Object> configMap = wxApi.getJsAPISign("http://www.oschina.net/question/2281024_223712");
		System.err.println("url" + configMap.get("url"));
	}

	@Test
	public void createQrcode() throws Exception {
		// 设备码
		System.err.println("url" + wxApi.createQrcode("0491725304232884"));
	}
}