...
import com.hx.xk.weixin.mp.vo.AuthInfo;
...
public class WxOpenApiImpl implements WxOpenApi {
	...
	public void refreshComponentToken() throws WxRespException {
		...
		try {
			result = SimpleHttpReq.post(WxApiUrl.COMPONENT_TOKEN_API,
					SimpleHttpReq.APPLICATION_JSON, data);
		} catch (IOException e) {
	...
	public AuthInfo queryAuth(String authCode) throws WxRespException {
		String url = String.format(WxApiUrl.COMPONENT_API, "api_query_auth",
				getComponentToken());
		String result = "";
		String data = "{" + "\"component_appid\":\"" + mpAct.getAppId()
	...
	@Override
	public String getAuthAccessToken(String authAppId, String authRefreshToken)
			throws WxRespException {
		return null;
	}

	@Override
	public void refreshAuthAccessToken(String authAppId, String authRefreshToken)
			throws WxRespException {
	...
	@Override
	public String getAuthorizerOption(String authAppId, String optionName)
			throws WxRespException {
		String url = String.format(WxApiUrl.COMPONENT_API,
				"api_get_authorizer_option", getComponentToken());
		String result = "";
		String data = "{" + "\"component_appid\":\"" + mpAct.getAppId() + "\","
	...
	@Override
	public void setAuthorizerOption(String authAppId, String optionName,
			String optionValue) throws WxRespException {
		String url = String.format(WxApiUrl.COMPONENT_API,
				"api_set_authorizer_option", getComponentToken());
		String result = "";
		String data = "{" + "\"component_appid\":\"" + mpAct.getAppId() + "\","
				+ "\"authorizer_appid\": \"" + authAppId + "\","
				+ "\"option_name\": \"" + optionName + "\","
