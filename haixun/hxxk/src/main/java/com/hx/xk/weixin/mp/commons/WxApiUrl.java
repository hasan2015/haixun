package com.hx.xk.weixin.mp.commons;
...
public interface WxApiUrl {
     ...
     * 微信API入口
     */
    public static final String WX_API_1 = "https://api.weixin.qq.com";
    public static final String WX_API = "https://api.weixin.qq.com/cgi-bin";
    public static final String WX_API_2 = "https://mp.weixin.qq.com/cgi-bin";
     ...
     * 网页授权请求地址
     */
    public static final String WEB_OAUTH2 = "/connect/oauth2/authorize?appid=%1$s&redirect_uri=%2$s&response_type=code&scope=%3$s&state=%4$s#wechat_redirect";
    /**
     * 网页授权获取TOKEN
     */
    public static final String OAUTH_TOKEN = "/sns/oauth2/access_token?appid=%1$s&secret=%2$s&code=%3$s&grant_type=authorization_code";
    /**
     * 网页授权刷新TOKEN
     */
    public static final String OAUTH_TOKEN_REFRESH = "/sns/oauth2/refresh_token?appid=%1$s&grant_type=refresh_token&refresh_token=%2$s";
    /**
     * 网页授权取得用户信息地址
     */
     ...
     * 生成永久二维码地址
     */
    public static final String QRCODE_CREATE = WX_API + "/qrcode/create?access_token=%1$s";
    /**
     * 获取二维码地址
     */
    public static final String QRCODE_TICKET_URL = WX_API_2 + "/showqrcode?ticket=%1$s";
