...
public interface WxApi {
	...
	//String getAccessToken4Page() throws WxRespException;

	String getAccessToken4Page(String code) throws WxRespException;

	DtoResult refreshAccessToken4Page(String refreshtoken) throws WxRespException;

	/**
	 * 创建ACCESS_TOKEN
	 * 
	 * @return 高级API需要的access_token
	 * @throws com.hx.xk.weixin.mp.exception.WxRespException
	 */
	...
	String createQrcode(String scene_str) throws WxRespException;
	 ...
	 * @throws com.hx.xk.weixin.mp.exception.WxRespException
	 */
	boolean sendTemplateMsg(String openId, String templateId, String topColor, String url, Template... templates)
	 ...
	 * 
	 * @param msg
	 *            消息输出实体[groupId或toUsers, content, msgType, mediaId]
	 * @return 消息ID
	 * @throws com.hx.xk.weixin.mp.exception.WxRespException
	 */
