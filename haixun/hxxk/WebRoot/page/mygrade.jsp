...
<script type="text/javascript"
	src="../js/mygrade.js?t=<%=new Date().getTime()%>"></script> 
<script type="text/javascript"
	src="../js/mygradeinfo.js?t=<%=new Date().getTime()%>"></script>

</head>
<body>
	<div id="p-mygrade" data-role="page">
		<!-- 解决header会fixed失效 data-tap-toggle="false" style="position: fixed;"-->
		<div id="header-p-mygrade" data-role="header" data-type="horizontal"
		...
		<div data-role="content"
			...
			<div id="cset-year" data-role="collapsible-set">
				<!-- 
